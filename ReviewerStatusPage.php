        ...
        <div class="ReviewerStatusSize" id="ReviewerStatusSize">
            ...
            <fieldset>
                ...
                <div style="display:flex;">
                    <div class="text">
                        <p class="textP">稿件編號：</p>
                    </div>
                    <div class="textPp "><span style="border-bottom: 1px #cccccc solid;">Q12345678</span></div>
                </div>
                <div style="display:flex;">
                    <div class="text">
                        <p class="textP">作品名稱：</p>
                    </div>
                    <div class="textPp "><span style="border-bottom: 1px #cccccc solid;">望小名的成長日記</span></div>
                </div>
                <div style="display:flex;">
                    <div class="text">
                        <p class="textP">投稿者姓名：</p>
                    </div>
                    <div class="textPp "><span style="border-bottom: 1px #cccccc solid;">望小名</span></div>
                </div>
                <div style="display:flex;">
                    <div class="text">
                        <p class="textP">稿件類別：</p>
                    </div>
                    <div class="textPp "><span style="border-bottom: 1px #cccccc solid;">無</span></div>
                </div>
                <div style="display:flex;">
                    <div class="text">
                        <p class="textP">作品摘要：</p>
                    </div>
                    <div class="textPp "><textarea name="text" id="text" cols="30" rows="10"></textarea></div>
                </div>
            ...
            <fieldset>
                <legend>檔案下載</legend>
                <li class="dw-wrap">
                    <a href="https://jquery.com/download/" class="dw-link dw-item">
                        <div class="dw-name">
                            <p class="dw-title">檔名</p>
                        </div>
