...
require_once("sqlLink.php");
    ...
    or die("無法開啟資料連接!<br/>");
						    $sql = "SELECT articleID , articlename , invitationdate , deadline , state FROM article WHERE state = '評閱中'"; 
            ...
            <div class="ReaderTitle">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">
                        <div class="breadcrumb-div"><a href="ReviewerFrontPage.php">所有評閱</a></div>
                    </li>
                </ol>
            </div>
            <div class="order">
                <span style="white-space:pre"> </span><span class="line"></span>
                <span style="white-space:pre"> </span><span class="txt">評閱中</span>
                <span style="white-space:pre"> </span><span class="line"></span>
            </div>
            <table class="tableR">
                <tbody>
					...
					while ($row = mysqli_fetch_row($result)){
						...
						if($i==0){
								echo"<td><a href='ReviewerStatusPage評閱中.php?id=$row[$i]'>$row[$i]</a></td>";
							continue;
							}
